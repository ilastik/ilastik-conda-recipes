...
VERSION_INFO_LINE=`grep --no-filename "__version_info__.*="  ${PREFIX}/ilastik-meta/ilastik/ilastik/__init__.py`
...
cat > ${PREFIX}/lib/python3.5/site-packages/ilastik-meta.pth << EOF
